...
class DisplayTaskController extends AbstractController
{
    ...
    {
        return $this->displayTasksByPriority();
    }
    ...
    public function displayTasksByPriority()
    {
        ...
        $priority_repo = $entityManager->getRepository(Task::class);

        // get tasks lists
        $critical_tasks = $priority_repo->findAllByPriorityAndOwner(4, $user_id);
        $important_tasks = $priority_repo->findAllByPriorityAndOwner(3, $user_id);
        $normal_tasks = $priority_repo->findAllByPriorityAndOwner(2, $user_id);
        $optional_tasks = $priority_repo->findAllByPriorityAndOwner(1, $user_id);
